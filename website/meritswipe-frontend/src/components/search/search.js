...
const Searchbar = () => {
    ...
    const categories = ["All Offers", "Dining", "Apparel", "Grocery", "Electronics"];
    ...
    const filteredData = dealsData.filter((deal) => {
        ...
        const cardNames = deal.associations?.map(a => a.name.toLowerCase()).join(" ") || "";
    ...
    return (
        <div className="merit-swipe-container">
            <div className="hero-section">
                <h1>Discover <span className="highlight">Premium</span> Rewards</h1>
                <p className="subtitle">Search 500+ restaurants, stores, and services for exclusive card discounts.</p>
                    ...
                    filteredData.map((deal) => (
                        <div key={deal.dealId} className="merit-card">
                            <div className="card-image-wrapper">
                                <img src={deal.targetEntityLogo} alt={deal.targetEntityName} className="main-image" />
                                <div className="discount-badge">{deal.percentageValue}% OFF</div>
                            ...
                            <div className="card-content">
                                ...
                                <div className="card-footer">
                                    <div className="bank-info">
                                        <img src={deal.sourceEntityLogo} alt="Bank" className="mini-bank-logo" />
